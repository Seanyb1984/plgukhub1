      ...
      fields: [
        ...
        },
        {
          ...
          options: [
            ...
            { value: 'intimate', label: 'Intimate Areas' },
      ...
      fields: [
        {
          ...
          options: [
            ...
            { value: 'underarms', label: 'Underarms' },
            { value: 'eyebrows', label: 'Eyebrows' },
            { value: 'intimate', label: 'Intimate Waxing' },
          ],
          validation: { required: true },
        },
      ],
      ...
      fields: [
        {
          ...
          options: [
            { value: 'standard', label: 'Standard Intimate Wax' },
            { value: 'full', label: 'Full Intimate Wax (including back passage)' },
            { value: 'buttocks', label: 'Buttocks Only' },
          ],
          validation: { required: true },
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'checkbox',
          label: 'I understand the treatment will be conducted in a professional manner',
          validation: { required: true },
        },
      ],
    },
      ...
      fields: [
        {
          ...
          type: 'paragraph',
          label: '',
          content: 'For hygiene and comfort, we ask that clients:',
        },
        {
          id: 'confirm_hygiene',
          type: 'checkbox',
        ...
        },
        {
          id: 'no_infection',
          type: 'checkbox',
          label: 'I confirm I do not have any active infections or STIs affecting the treatment area',
          validation: { required: true },
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          id: 'consent_touch',
          type: 'checkbox',
          label: 'I understand the therapist may need to touch intimate areas to perform the treatment safely',
          validation: { required: true },
        },
        {
          id: 'can_stop',
...
const aftercareAcknowledgement: FormDefinition = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: 'Additional aftercare for intimate waxing',
      conditionalLogic: {
        action: 'show',
        conditions: [{ field: 'intimate_treatment', operator: 'equals', value: true }],
        logicType: 'and',
      },
      fields: [
        {
...
// ============================================
// EXPORT ALL WAX FOR MEN FORMS
// ============================================

export const waxForMenForms: FormDefinition[] = [
  clientIntake,
  contraindications,
