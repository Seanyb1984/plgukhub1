-- ============================================
-- PLG Hub Booking System — Schema Migration
...
-- Site ↔ Treatment junction (which treatments are offered at each site)
...
-- Staff schedule overrides (holidays, sick, custom hours)
